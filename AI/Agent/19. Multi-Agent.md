...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure6.png?raw=true)

<details>
    <summary>Business Analyst</summary>

사용자 요구와 AI 추천을 분석하여 목표(goal)와 작업 방법(method)을 도출
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure7.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure8.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure9.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure10.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure11.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure12.png?raw=true)
...
![alt text](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Figure/Figure13.png?raw=true)
...
[outline_template.md](https://github.com/Heejinee3/Study/blob/master/AI/Agent/Data/outline_template.md?raw=true)
