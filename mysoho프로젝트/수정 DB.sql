...
INSERT INTO member VALUES( NULL, 'hong2eee', '1234', '홍길동', 'VIP', 'hong@gmail.com',
  '01022223333', DEFAULT,'54321','파푸아뉴기니','앞바다', '2000-01-01',DEFAULT,default ,default );
...
INSERT INTO member VALUES( NULL, 'right나', '1234', '나', '일반회원', 'IsThatRight@gmail.com',
'01022223333', DEFAULT,'12345','금수산태양궁전','정문', default, default,default , DEFAULT);
INSERT INTO member VALUES( NULL, 'right가', '1234', '가', '일반회원', 'IsThatRight@gmail.com',
'01022223333', DEFAULT,'12345','금수산태양궁전','정문', default, default,default , DEFAULT);


INSERT INTO member VALUES( NULL, 'ADMIN1', '1234', 'ADMIN1','ADMIN_RATING', 'ADMIN_EMAIL',
'ADMIN_NUM', DEFAULT,'ADMIN_POST','ADMIN_ADDR1','ADMIN_ADDR2', default, DEFAULT,'ADMIN', default); 
INSERT INTO member VALUES( NULL, 'ADMIN2', '1234', 'ADMIN2','ADMIN_RATING', 'ADMIN_EMAIL',
'ADMIN_NUM', DEFAULT,'ADMIN_POST','ADMIN_ADDR1','ADMIN_ADDR2', default, DEFAULT,'ADMIN', default);
INSERT INTO member VALUES( NULL, 'ADMIN3', '1234', 'ADMIN2','ADMIN_RATING', 'ADMIN_EMAIL',
'ADMIN_NUM', DEFAULT,'ADMIN_POST','ADMIN_ADDR1','ADMIN_ADDR2', default, DEFAULT,'ADMIN', DEFAULT);
...
BEGIN
    ...
    WHILE (i <= count) DO/*1부터 호출시 입력한 숫자만큼 반복*/
		  INSERT INTO member VALUES( NULL, CONCAT('hong',LAST_INSERT_ID()), '1234',  CONCAT('홍길동',LAST_INSERT_ID()), 'VIP', 'hong@gmail.com',
  '01022223333', DEFAULT,'54321','파푸아뉴기니','앞바다',DEFAULT ,DEFAULT, DEFAULT ,DEFAULT );
  		  INSERT INTO member VALUES( NULL, CONCAT('hong',LAST_INSERT_ID()), '1234',  CONCAT('홍길동',LAST_INSERT_ID()), '일반회원', 'hong@gmail.com',
  '01022223333', DEFAULT,'54321','파푸아뉴기니','앞바다',DEFAULT ,DEFAULT, DEFAULT ,DEFAULT );
...
CALL auto_insert(100); /* 1121개 데이터  인서트 해봐~ */
...
BEGIN
    DECLARE i INT DEFAULT 1;/* 변수 I에 1 초기화 */
    WHILE (i <= count) DO/*1부터 호출시 입력한 숫자만큼 반복*/
			INSERT INTO item VALUES(NULL, 'TOP', '골지 브이티', '블랙', 'FREE', '19900', '0', 'https://img.makeshop.co.kr/1/1371/201902/81f5662d13dcab1ce7ee6fd978bbb5f5.png', DEFAULT, DEFAULT, '품절', DEFAULT);
        SET i = i + 1; /* 루프가 끝나기전 I변수 1증가 */
    END WHILE; /* 반복  */
END;;
DELIMITER ; /* 프로시저 종료 지점 마찬가지로 DELIMITER 사이 공백 지우면 에러남.*/
...
INSERT INTO `cart` VALUES(NULL, '55555', 'right', NULL , '20001', '퍼프블라우스', '화이트', 'FREE', 1, DEFAULT);
...
BEGIN
    ...
    WHILE (i <= count) DO/*1부터 호출시 입력한 숫자만큼 반복*/
		...
		INSERT INTO `cart` VALUES(NULL,LAST_INSERT_ID(), 'right', NULL , '20001', '퍼프블라우스', '화이트', 'FREE', 1, DEFAULT);
		SET i = i + 1; /* 루프가 끝나기전 I변수 1증가 */
    END WHILE; /* 반복  */
END;;
DELIMITER ; /* 프로시저 종료 지점 마찬가지로 DELIMITER 사이 공백 지우면 에러남.*/
...
INSERT INTO `order`
	VALUES (NULL, '22222', '10055', NULL, NULL, NULL, 35000, 1,
...
INSERT INTO `order`
	VALUES (NULL, '44444', NULL, NULL, NULL, NULL, 35000, 1,
          '홍길동', '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, default, '무통장입금', '입금전', default);
INSERT INTO `order`
	VALUES (NULL, '55555', NULL, NULL, NULL, NULL, 35000, 1,
          '홍길동', '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, default, '무통장입금', '입금전', default);
...
BEGIN
    ...
    WHILE (i <= count) DO/*1부터 호출시 입력한 숫자만큼 반복*/
		...
		INSERT INTO `order`
			VALUES (NULL, LAST_INSERT_ID(), NULL, NULL, NULL, NULL, 35000, 1,
          CONCAT('hong',LAST_INSERT_ID()), '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, default, '무통장입금', '미입금/주문완료', default);
   	INSERT INTO `order`
			VALUES (NULL, LAST_INSERT_ID(), NULL, NULL, NULL, NULL, 35000, 1,
          CONCAT('hong',LAST_INSERT_ID()), '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, default, '무통장입금', '배송대기', default);
      INSERT INTO `order`
			VALUES (NULL, LAST_INSERT_ID(), NULL, NULL, NULL, NULL, 35000, 1,
          CONCAT('hong',LAST_INSERT_ID()), '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, default, '무통장입금', '배송중', DEFAULT);
   	INSERT INTO `order`
			VALUES (NULL, LAST_INSERT_ID(), NULL, NULL, NULL, NULL, 35000, 1,
          '날짜바뀜', '01022223333', '홍길동엄마', '01044445555', '12345', '서울시 마포구 갈매기동', '나머지주소',
          default, DEFAULT, '무통장입금', '미입금/주문완료', '2023-02-20');
		SET i = i + 1; /* 루프가 끝나기전 I변수 1증가 */
    END WHILE; /* 반복  */
END;;
DELIMITER ; /* 프로시저 종료 지점 마찬가지로 DELIMITER 사이 공백 지우면 에러남.*/

CALL auto_insert(10); /* 1121개 데이터  인서트 해봐~ */
